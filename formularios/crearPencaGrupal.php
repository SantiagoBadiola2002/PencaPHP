...
function generarCodigoInvitacion($longitud = 8) {
    $caracteres = '0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ';
    $longitudCaracteres = strlen($caracteres);
    $codigoInvitacion = '';
    for ($i = 0; $i < $longitud; $i++) {
        $codigoInvitacion .= $caracteres[rand(0, $longitudCaracteres - 1)];
    }
...
<head>
    ...
    <title>Crear Penca Grupal</title>
...
<div class="container-fluid">
  <div class="form-container">
    <h1>Crear Penca Grupal</h1>
    <br>
    
    <form action= "../persistencia/registrarPencaGrupalEnBD.php" method="post">
    ...
    <input type="text" class="form-control" id="codigoInvitacion" name="codigoInvitacion" value="<?php echo $codigoInvitacion; ?>" required>
</div>
