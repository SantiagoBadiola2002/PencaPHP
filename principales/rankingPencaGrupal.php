...
$consulta = "SELECT * FROM Penca_Grupal ORDER BY puntosActuales DESC";
...
<head>
    ...
    <title>Ranking Pencas Grupales</title>
...
<h1 style="text-align: center;">Ranking Grupal</h1>
    <table class="table table-striped">
        <tr>
            <th>ID</th>
            <th>Nombre</th>
            <th>Usuario</th>
            <th>Codigo Invitación</th>
            <th>ID Predicción</th>
        ...
        if ($resultado->num_rows > 0) {
            ...
            while ($fila = $resultado->fetch_assoc()) {
                echo "<tr>";
                echo "<td>" . $fila["idPencaGrupal"] . "</td>";
                echo "<td>" . $fila["nombre"] . "</td>";
                echo "<td>" . $fila["Usuario"] . "</td>";
                echo "<td>" . $fila["codigoInvitacion"] . "</td>";
